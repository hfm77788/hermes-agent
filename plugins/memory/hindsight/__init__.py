...
from .embedded import (
    _build_embedded_profile_env, _embedded_llm_api_key, _embedded_profile_env_path,
    _load_simple_env, _materialize_embedded_profile_env, _may_rewrite_profile_env,
)
...
def _check_api_supports_update_mode_append(api_url: str,
    ...
    Probes once per URL and key fingerprint per process. Returns False on any probe failure —
...
class HindsightMemoryProvider(MemoryProvider):
        ...
        if self._client is None:
            if self._mode == "local_embedded":
                ...
                kwargs = dict(
                    ...
                    llm_api_key=_embedded_llm_api_key(self._config),
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._api_url = self._config.get("api_url") or get_secret("HINDSIGHT_API_URL", "") or default_url
        ...
        self._apply_retain_settings(self._config)
    ...
    def _apply_retain_policy(self, cfg: dict) -> None:
        ...
        self._retain_context = cfg.get("retain_context", "conversation between Hermes Agent and the User")
