...
# local: leaked tool-call bracket payload scrubber (backport, audit 2026-08-04)
...
class FeishuAdapter(BasePlatformAdapter):
    ...
    async def _dispatch_synthetic_event(
        ...
        synthetic_event = MessageEvent(
            ...
            # local: registry-enriched channel prompt (fork) over upstream params
            channel_prompt=self._enrich_channel_prompt_with_registry(
                chat_id,
                getattr(sender_id, "open_id", None) or "",
